  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className={`px-4 py-2 bg-linear-to-r ${currentTheme.from} ${currentTheme.to} text-white rounded-lg font-medium shadow-lg hover:shadow-xl transition-shadow flex items-center space-x-2`}
      >
          ...
          >
            <div className="p-2 space-y-1">
              {themes.map((theme) => (
                ...
                >
                  <div
                    className={`w-6 h-6 rounded-full bg-linear-to-r ${theme.from} ${theme.to}`}
                  ></div>
